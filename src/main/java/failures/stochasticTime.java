...
public class stochasticTime {
    ...
    public boolean isConveyorFinished() {
        return /*smConv.equals(SM_conv.END) */ smConv2.equals(SM_conv2.END);
    }
