...
/*
                    ...
                    case 5 -> {
                        ...
                        System.out.print("    How many conveyors to manipulate its stochasticTime ?");
                        in = input.nextLine();
                        int nElements = Integer.parseInt(in);
                    ...
                    case 10 -> {
                        ...
                        System.out.println("    2 - List/Change running stochasticTime parameters;");
                        System.out.println("    0 - Exit program;");
                    ...
                    case 11 -> {
                        currBlock = null;
                        System.out.println("**** Running stochasticTime Parameters  ****");
                        ...
                        if (currBlock == null) {
                            ...
                            for (monitor.stochasticTime.conveyor convMon : currBlock.getMonitorTimeConveyors()) {
                                ...
                                if (print) {
                                    ...
                                    System.out.println(convMon.getTimestamps().size() + " parts moved with mean stochasticTime " + df.format(duration / (convMon.getTimestamps().size() - discount)) + " s");
                                    System.out.println();
                                }
                            }
                        }
                        ...
                        System.out.print("     Change stop stochasticTime (y/n)?");
                        if (input.nextLine().contains("y")) {
                            ...
                            if (temp == null)
                                ...
                                System.out.println("       Current stochasticTime value: " + temp.getTime_adjust_param());
                                System.out.print("       New stochasticTime value:");
